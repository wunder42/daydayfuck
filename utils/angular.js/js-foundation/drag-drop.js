...
(function() {
  var $, activeItem, activeManager, beforeOrAfter, curItem, drag, dragManager, initManager, isIn, isMouseDown, itemCopy, mouseCoords, mouseDown, mouseMove, mouseOffset, mouseOffsetElement, mousePosition, mouseUp, nextElement, previousElment, startDrag, updatePosition;
    ...
    if (isMouseDown && curItem) {
      ...
      if (activeManager) {
        ...
        for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
          item = _ref[_j];
          item = $(item);
          if (curItem !== item && isIn(itemCopy, item)) {
      ...
      if (activeItem) {
        ...
        } else if (beforeOrAfter(itemCopy, activeItem) === 'after' && activeItem !== previousElment(curItem)) {
